...
function PANEL:PostInit()
    ...
    backViewButton:SetText("Вращать")
    ...
    local presetNameEntry = vgui.Create("DTextEntry", presetsPanel)
    ...
    savePresetBtn:SetSize(ScreenScale(38), ScreenScale(16))
    ...
    loadPresetBtn:SetSize(ScreenScale(38), ScreenScale(20))
    ...
    function hatSelector:DoClick()
        ...
        hatSelectMenu = CreateStyledAccessoryMenu(nil, "Выбрать шляпу")
    ...
    faceMatSelector:SetText("Лицо (текстура)")
