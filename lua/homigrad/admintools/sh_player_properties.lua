...
properties.Add( "notify", {
	MenuLabel = "Уведомить", -- Name to display on the context menu
...
properties.Add( "givegun", {
	MenuLabel = "Дать", -- Name to display on the context menu
...
properties.Add( "strip", {
	MenuLabel = "Забрать оружие", -- Name to display on the context menu
...
properties.Add( "fullstrip", {
	MenuLabel = "Забрать всё", -- Name to display on the context menu
...
properties.Add( "freeze", {
	MenuLabel = "Заморозить", -- Name to display on the context menu
...
properties.Add( "snatch", {
	MenuLabel = "Похитить", -- Name to display on the context menu
...
properties.Add( "ragdollize", {
	MenuLabel = "Оглушить/Поднять", -- Name to display on the context menu
...
properties.Add( "lobotomize", {
	MenuLabel = "Лоботомия", -- Name to display on the context menu
...
properties.Add( "setplayerclass", {
	MenuLabel = "Установить класс игрока", -- Name to display on the context menu
...
properties.Add( "door_unlock", {
    MenuLabel = "Разблокировать дверь",
    Order = 9,
...
properties.Add( "respawn_lply_in_rag", {
	MenuLabel = "Вселиться", -- Name to display on the context menu
	Order = 2, -- The order to display this property relative to other properties
	MenuIcon = "icon16/heart.png", -- The icon to display next to the property
...
properties.Add( "respawn_ragply_in_rag", {
	MenuLabel = "Вселить владельца", -- Name to display on the context menu
	Order = 3, -- The order to display this property relative to other properties
	MenuIcon = "icon16/heart.png", -- The icon to display next to the property
