...
local BootStages = {
	[1] = function(init2)
		draw.SimpleText("Запуск системы", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[2] = function(init2)
		draw.SimpleText("Запуск системы", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS Версия: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[3] = function(init2)
		draw.SimpleText("Запуск системы", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS Версия: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Глобальная проверка системы:", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 2 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[4] = function(init2)
		draw.SimpleText("Запуск системы", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS Версия: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Глобальная проверка системы:", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 2 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Оптика: OK", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 3 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Сенсоры: OK", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 4 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Слух: OK", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 5 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Нюх: МОДУЛЬ НЕ НАЙДЕН", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 6 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Вкус: МОДУЛЬ НЕ НАЙДЕН", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 7 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[5] = function(init2)
		draw.SimpleText("Запуск системы", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS Версия: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("Нюх: МОДУЛЬ НЕ НАЙДЕН", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 6 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Вкус: МОДУЛЬ НЕ НАЙДЕН", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 7 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Сканирование памяти: В прогрессе", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 8 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[6] = function(init2)
		draw.SimpleText("Запуск системы", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS Версия: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	...
	[7] = function(init2)
		...
		draw.SimpleText("Нюх: МОДУЛЬ НЕ НАЙДЕН", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 6 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Вкус: МОДУЛЬ НЕ НАЙДЕН", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 7 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Сканирование памяти: ВЫПОЛНЕНО", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 8 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Настройка памяти: В процессе", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 9 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[8] = function(init2)
		draw.SimpleText("Запуск системы", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS Версия: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("Вкус: МОДУЛЬ НЕ НАЙДЕН", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 7 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Сканирование памяти: ВЫПОЛНЕНО", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 8 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Настройка памяти: ВЫПОЛНЕНО", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 9 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[9] = function(init2)
	    draw.SimpleText("Запуск системы", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS Версия: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("Сканирование памяти: ВЫПОЛНЕНО", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 8 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Настройка памяти: ВЫПОЛНЕНО", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 9 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Инициализация сознания...", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 10 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
	[10] = function(init2)
		draw.SimpleText("Запуск системы", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05, ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("OwOS Версия: 2.13.0", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 1 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		...
		draw.SimpleText("Настройка памяти: ВЫПОЛНЕНО", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 9 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Инициализация сознания...", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 10 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
		draw.SimpleText("Выполнить \"Желаю вам :3 дня!\"", "ZB_ProotOSSmall", sw * 0.012, sh * 0.05 + 11 * ScreenScale(5), ColorAlpha(bluewhite, 255 * init2), TEXT_ALIGN_LEFT, TEXT_ALIGN_CENTER)
	end,
}
...
hook.Add("RenderScreenspaceEffects", "furload", function()
	if IsValid(hg.furload) and hg.furload.alpha != 255 then
		...
		draw.SimpleText("Желаю вам :3 дня!", "ZB_ProotOSMedium", sw * 0.5 + 2, sh * 0.8 + 2, ColorAlpha(color_black, 255 * alpha), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
		draw.SimpleText("Желаю вам :3 дня!", "ZB_ProotOSMedium", sw * 0.5, sh * 0.8, ColorAlpha(bluewhite, 255 * alpha), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
	end
end)
