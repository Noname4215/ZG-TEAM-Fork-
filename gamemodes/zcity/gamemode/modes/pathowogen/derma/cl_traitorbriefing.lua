...
function PANEL:Init()
    ...
    self.dialogue:SetText("Твоя задача просто: Убей всех выживших. Вы должны будете приобрести оборудование на месте, и мы вытащим вас только после завершения вашей миссии..", 2)
