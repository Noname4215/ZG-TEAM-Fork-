...
function PANEL:Init()
	...
	self.dialogue:SetText("В вашем регионе распространяется неизвестный патогенный вирус. Ваше местонахождение с настоящего момента находится под карантином до дальнейшего уведомления. В это время мы постараемся найти способ вашей эвакуации.", 2)
	timer.Simple(15, function()
		if !IsValid(self) then return end
		self.dialogue:SetText("Оставайтесь в безопасности. Конец связи.")
