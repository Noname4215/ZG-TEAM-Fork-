if CLIENT then
    ...
    local function CreateQueuePanel(frame)
        ...
        titleLabel:SetText("Очередь Режимов Игры")
        ...
        saveBtn.DoClick = function()
            //if #zb.RoundList > 0 then
                ...
                chat.AddText(Color(0, 255, 0), "Очередь режимов игры установлена!")
            //else
        ...
        clearBtn.DoClick = function()
            ...
            chat.AddText(Color(255, 165, 0), "Очередь режимов игры очищена!")
        end
    ...
    local function OpenModeSelection(command)
        ...
        frame:Center()
        frame:SetTitle("Менеджер Режимов Игры")
        frame:MakePopup()
        ...
        titleLabel:SetText("Доступные Режимы Игры")
        titleLabel:SetFont("DermaLarge")
        titleLabel:SetTextColor(Color(255, 200, 0))
        titleLabel:Dock(TOP)
        titleLabel:DockMargin(0, 5, 0, 5)
        ...
        searchBar:SetPlaceholderText("Поиск режимов игры...")
        searchBar:Dock(TOP)
        ...
        for i, mode in SortedPairsByMemberValue(zb.availableModes,"canlaunch",true) do
            ...
            modeBtn:SetTooltip("Нажмите, чтобы выбрать/отменить выбор режима")
        ...
        batchTitle:SetText("Пакетные Операции")
    ...
    local function OpenAdminMenu()
        ...
        setForceModeBtn:SetText("Установить Авто Следующий Режим")
        ...
        queueModeBtn:SetText("Управление Очередью Режимов Игры")
